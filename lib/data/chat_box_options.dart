...
class ChatBoxOptions {
  ...
  static ChatBoxOptions of(BuildContext context) {
    final scope =
    context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>()!;
    return scope.modelBindingState.currentModel;
  }

  static void update(BuildContext context, ChatBoxOptions newModel) {
    final scope =
    context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>()!;
...
class ModelBinding extends StatefulWidget {
  ...
  final ChatBoxOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  late ChatBoxOptions currentModel;
  ...
  void handleTimeDilation(ChatBoxOptions newModel) {
  ...
  void updateModel(ChatBoxOptions newModel) {
